...
۵. **گرفتن expert bundle ی Tor (برای تغییردهنده‌ی IP)**
...
۶. **اجرا در حالت توسعه**

   ```sh
   npm run tauri dev
   ```

۷. **ساختن نصب‌کننده‌ی نهایی**
