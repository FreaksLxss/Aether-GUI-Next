      ...
      <SelectContent className="rounded-[35px] bg-surface-2 p-1 ring-1 ring-white/10">
        {OPTIONS.map((opt) => (
          <SelectItem
            key={opt.value}
            value={opt.value}
            className="cursor-pointer rounded-[35px] px-2.5 py-2 text-xs outline-none transition-colors focus:bg-primary/15 focus:text-foreground data-[highlighted]:bg-primary/15"
          >
