...
function HistorySparkline({ entries }: { entries: ConnectionHistoryEntry[] }) {
  ...
  return (
    <div className="rounded-[35px] bg-black/10 px-2.5 py-2 ring-1 ring-white/[0.04] light:bg-black/[0.02] light:ring-black/[0.04]">
...
export function ConnectionHistoryContent() {
  ...
  if (history.length === 0) {
    return (
      <div className="flex flex-col items-center gap-2 rounded-[35px] border-0 bg-card px-4 py-10 shadow-[0_16px_48px_-20px_rgba(0,0,0,0.75),0_8px_24px_-12px_rgba(0,0,0,0.55),inset_0_1px_0_0_rgba(255,255,255,0.06)] light:border light:border-dashed light:border-black/10 light:shadow-none">
    ...
    <div className="flex flex-col gap-3">
      {stats && (
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-[35px] bg-card px-2.5 py-2 shadow-[0_8px_24px_-14px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.06)] light:border light:border-black/[0.06] light:shadow-none">
      ...
      <div className="flex flex-col gap-1.5 rounded-[35px] border-0 bg-card p-3 shadow-[0_16px_48px_-20px_rgba(0,0,0,0.75),0_8px_24px_-12px_rgba(0,0,0,0.55),inset_0_1px_0_0_rgba(255,255,255,0.06)] light:border light:border-black/[0.08] light:shadow-none">
