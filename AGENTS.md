...
- `src-tauri/aether-release.json` is the shared source of truth for the approved engine release, asset names and SHA-256 checksums. The GUI release is **0.17.1**; the pinned Aether engine is **2.0.0**. These are separate versions.
